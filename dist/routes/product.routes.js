...
router.post("/", upload_middleware_1.default.array("images", 10), ctrl.createProduct);
router.get("/", ctrl.listProductsForAdmin);
router.get("/category/:categoryId", ctrl.getProductsByCategory);
router.put("/:id", upload_middleware_1.default.array("images", 10), ctrl.updateProduct);
